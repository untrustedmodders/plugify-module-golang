...
extern __declspec(dllexport) GoUintptr NoParamReturnPtr64();
...
extern __declspec(dllexport) GoSlice NoParamReturnArrayPtr64();
...
extern __declspec(dllexport) void Param6(GoInt32 a, GoFloat32 b, GoFloat64 c, Vector4 d, GoSlice e, GoUint16 f);
extern __declspec(dllexport) void Param7(GoInt32 a, GoFloat32 b, GoFloat64 c, Vector4 d, GoSlice e, GoUint16 f, GoString g);
extern __declspec(dllexport) void Param8(GoInt32 a, GoFloat32 b, GoFloat64 c, Vector4 d, GoSlice e, GoUint16 f, GoString g, GoFloat32 h);
extern __declspec(dllexport) void Param9(GoInt32 a, GoFloat32 b, GoFloat64 c, Vector4 d, GoSlice e, GoUint16 f, GoString g, GoFloat32 h, GoInt16 k);
extern __declspec(dllexport) void Param10(GoInt32 a, GoFloat32 b, GoFloat64 c, Vector4 d, GoSlice e, GoUint16 f, GoString g, GoFloat32 h, GoInt16 k, GoUintptr l);
...
extern __declspec(dllexport) void ParamRef6(GoInt32* a, GoFloat32* b, GoFloat64* c, Vector4* d, GoSlice* e, GoUint16* f);
extern __declspec(dllexport) void ParamRef7(GoInt32* a, GoFloat32* b, GoFloat64* c, Vector4* d, GoSlice* e, GoUint16* f, GoString* g);
extern __declspec(dllexport) void ParamRef8(GoInt32* a, GoFloat32* b, GoFloat64* c, Vector4* d, GoSlice* e, GoUint16* f, GoString* g, GoFloat32* h);
extern __declspec(dllexport) void ParamRef9(GoInt32* a, GoFloat32* b, GoFloat64* c, Vector4* d, GoSlice* e, GoUint16* f, GoString* g, GoFloat32* h, GoInt16* k);
extern __declspec(dllexport) void ParamRef10(GoInt32* a, GoFloat32* b, GoFloat64* c, Vector4* d, GoSlice* e, GoUint16* f, GoString* g, GoFloat32* h, GoInt16* k, GoUintptr* l);
